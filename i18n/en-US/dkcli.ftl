...
confirm = Would you like to proceed with AOSC OS installation? If you proceed, YOUR DATA WILL BE CLEARED on the affected partition(s) and storage device(s)! (y/n)
confirm-autopart = Would you like to proceed with automatic partition? If you proceed, YOUR DATA WILL BE CLEARED on the selected storage device! (y/n)
